...
public class PageResourceImplTest {
  ...
  public void postPage_shouldThrowError_whenEmptyJson() {
    given()
        ...
        .statusCode(400)
        .body(sameJson(
            "{\"error\":{\"statusCode\":400,\"reason\":\"Bad Request\",\"message\":\"Validation Error\",\"errors\":{\"doctype\":\"may not be null\",\"referrer\":\"may not be null\",\"org\":\"may not be null\",\"url\":\"may not be null\"}}}"));
  }
