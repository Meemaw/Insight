...
public class RequestFilter implements ContainerRequestFilter, ContainerResponseFilter {
  ...
  public void filter(ContainerRequestContext requestContext,
    ...
    log.info("Request {} {} from IP {} took {}ms status {}", method, path, address, timeElapsed,
        responseContext.getStatus());
  }

  /**
   * Extracts time elapsed from the ContainerRequestContext. Start time in the context might be null
   * if 404 route is requested thus 0L is returned in that case.
   *
